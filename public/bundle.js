...
var app = (function (fs) {
	...
	*/
	...
	// `Array.prototype.reduce` method
	// https://tc39.github.io/ecma262/#sec-array.prototype.reduce
	_export({ target: 'Array', proto: true, forced: !STRICT_METHOD$4 || !USES_TO_LENGTH$7 || CHROME_BUG }, {
	...
	var FORCED$2 = NEGATIVE_ZERO$1 || !STRICT_METHOD$5 || !USES_TO_LENGTH$8;
	...
	try {
	  var raw = fs__default['default'].readFileSync('./.env.json');
	...
	dotEnv.config();
	var token = '$$app_token=' + process.env.OPENDATA; // Replace all occurences of the <replace> parameters in the <string> by the <replaceBy> parameter
	...
	/* src/components/Test.svelte generated by Svelte v3.29.7 */
	...
	function create_fragment$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(button, file$1, 11, 1, 166);
				attr_dev(main, "class", "svelte-1h6otfa");
				add_location(main, file$1, 9, 0, 149);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function instance$1($$self, $$props, $$invalidate) {
		...
		$$self.$capture_state = () => ({ Test, count, increment, $count });
		return [increment];
	}
